...
public class LookupService {
     ...
     */
    public Country getCountryV6(String ipAddress) throws InvalidDatabaseException {
        InetAddress addr;
        try {
     ...
     * @throws InvalidDatabaseException 
     */
    public Country getCountry(String ipAddress) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(ipAddress);
        } catch (UnknownHostException e) {
     ...
     * @throws InvalidDatabaseException 
     */
    public synchronized Country getCountry(InetAddress ipAddress) throws InvalidDatabaseException {
     ...
     * @throws InvalidDatabaseException 
     */
    public synchronized Country getCountryV6(InetAddress addr) throws InvalidDatabaseException {
     ...
     * @throws InvalidDatabaseException 
     */
    public synchronized Country getCountry(long ipAddress) throws InvalidDatabaseException {
        if (file == null && (dboptions & GEOIP_MEMORY_CACHE) == 0) {
            throw new IllegalStateException("Database has been closed.");
        }
    ...
    public int getID(String ipAddress) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(ipAddress);
        } catch (UnknownHostException e) {
    ...
    public int getID(InetAddress ipAddress) throws InvalidDatabaseException {
        return getID(bytesToLong(ipAddress.getAddress()));
    }

    public synchronized int getID(long ipAddress) throws InvalidDatabaseException {
        if (file == null && (dboptions & GEOIP_MEMORY_CACHE) == 0) {
            throw new IllegalStateException("Database has been closed.");
        }
     ...
     * @throws InvalidDatabaseException 
     */
    public synchronized DatabaseInfo getDatabaseInfo() throws InvalidDatabaseException {
    ...
    synchronized void _check_mtime() throws InvalidDatabaseException {
        try {
            if ((dboptions & GEOIP_CHECK_CACHE) != 0) {
    ...
    // for GeoIP City only
    public Location getLocationV6(String str) throws InvalidDatabaseException {
        InetAddress addr;
        try {
    ...
    // for GeoIP City only
    public Location getLocation(InetAddress addr) throws InvalidDatabaseException {
        return getLocation(bytesToLong(addr.getAddress()));
    }

    // for GeoIP City only
    public Location getLocation(String str) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(str);
        } catch (UnknownHostException e) {
    ...
    public synchronized Region getRegion(String str) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(str);
        } catch (UnknownHostException e) {
    ...
    public synchronized Region getRegion(InetAddress addr) throws InvalidDatabaseException {
        return getRegion(bytesToLong(addr.getAddress()));
    }

    public synchronized Region getRegion(long ipnum) throws InvalidDatabaseException {
    ...
    public synchronized Location getLocationV6(InetAddress addr) throws InvalidDatabaseException {
        int seekCountry;
    ...
    public synchronized Location getLocation(long ipnum) throws InvalidDatabaseException {
        int seekCountry;
    ...
    private static float readAngle(ByteBuffer buffer) throws InvalidDatabaseException {
    ...
    private static int readMetroAreaCombo(ByteBuffer buffer) throws InvalidDatabaseException {
        if (buffer.remaining() < 3) {
    ...
    public String getOrg(InetAddress addr) throws InvalidDatabaseException {
        return getOrg(bytesToLong(addr.getAddress()));
    }

    public String getOrg(String str) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(str);
        } catch (UnknownHostException e) {
    ...
    public synchronized String getOrg(long ipnum) throws InvalidDatabaseException {
        try {
    ...
    public String getOrgV6(String str) throws InvalidDatabaseException {
        InetAddress addr;
        try {
            addr = InetAddress.getByName(str);
        } catch (UnknownHostException e) {
    ...
    // GeoIP Organization and ISP Edition methods
    public synchronized String getOrgV6(InetAddress addr) throws InvalidDatabaseException {
          try {
     ...
     * @throws InvalidDatabaseException 
     */
    private synchronized int seekCountryV6(InetAddress addr) throws InvalidDatabaseException {
     ...
     * @throws InvalidDatabaseException 
     */
    private synchronized int seekCountry(long ipAddress) throws InvalidDatabaseException {
        byte[] buf = new byte[2 * MAX_RECORD_LENGTH];
        int[] x = new int[2];
        int offset = 0;
        _check_mtime();
    ...
    private void readNode(byte[] buf, int[] x, int offset) throws InvalidDatabaseException {
        if ((dboptions & GEOIP_MEMORY_CACHE) == 1) {
            // read from memory
